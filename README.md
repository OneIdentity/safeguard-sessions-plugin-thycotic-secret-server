# safeguard-sessions-plugin-thycotic-secret-server
Thycotic Secret Server plugin for Safeguard for Privileged Sessions

# Support
- One Identity is *not* an official partner of Thycotic and this plugin is *not* an approved or certified integration with the Thycotic product.
